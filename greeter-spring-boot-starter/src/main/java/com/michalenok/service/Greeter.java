package com.michalenok.service;

import com.michalenok.configuration.GreetingConfiguration;
...
public class Greeter {
    private GreetingConfiguration greetingConfig;

    public Greeter(GreetingConfiguration greetingConfig) {
